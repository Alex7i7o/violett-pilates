...
prof_tab_hoy = """import React from 'react';
...
prof_tab_mes = """import React from 'react';
import { Card, CardContent } from '../ui/Card';
import { Badge } from '../ui/Badge';
import { type ProfesorDashboardData } from '../../types/profesor';
...
with open(f"{components_dir}/ProfesorTabHoy.tsx", "w", encoding='utf-8') as f:
    f.write(prof_tab_hoy)

with open(f"{components_dir}/ProfesorTabMes.tsx", "w", encoding='utf-8') as f:
    f.write(prof_tab_mes)
