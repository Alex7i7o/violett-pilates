...
"""
Django settings for fireseed_project project.
...
ROOT_URLCONF = 'fireseed_project.urls'
...
WSGI_APPLICATION = 'fireseed_project.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://violett_user:violett_password@localhost:5432/violett_db',
        conn_max_age=600,
    )
}
