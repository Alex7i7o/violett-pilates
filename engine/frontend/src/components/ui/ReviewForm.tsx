...
export function ReviewForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await api.post('/resenas/', { estrellas: rating, mensaje: comment });
  ...
  if (submitted) {
    return (
      <Card className="bg-primary-light/50/50 border-primary-light mt-12 mb-8">
        <CardContent className="p-8 text-center">
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="flex justify-center mb-4 text-4xl">
            🎉
          </motion.div>
          <h3 className="text-xl font-bold text-primary-main mb-2">¡Muchísimas gracias!</h3>
  ...
  return (
    <Card className="mt-12 mb-8 overflow-hidden border-primary-light shadow-soft relative">
      {/* Decorative gradient */}
        ...
        <div className="md:flex gap-8 items-start">
          ...
          <div className="md:w-2/3 space-y-4">
            ...
            <div>
              ...
              <textarea 
                className="w-full rounded-xl border border-primary-light p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-main bg-gray-50/50 resize-none"
                rows={3}
