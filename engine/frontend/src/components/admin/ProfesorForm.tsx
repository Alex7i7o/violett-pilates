    ...
    <form 
      ...
      onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" name="apellido" required value={formData.apellido} onChange={handleChange} className="w-full p-2.5 rounded-xl border border-primary-light focus:outline-none focus:ring-2 focus:ring-primary-main" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="color" name="color_identificador" value={formData.color_identificador} onChange={handleChange} className="w-full h-11 px-1 py-1 rounded-xl cursor-pointer border border-primary-light" />
        </div>
      </div>
