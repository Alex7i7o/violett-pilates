    ...
    <>
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted mt-1">Bienvenida de nuevo al {isEstética ? 'Panel de Pacientes' : 'Panel de Alumnas'}.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-primary-main text-white border-none shadow-glass">
        ...
        <Card>
          ...
          <CardContent className="flex items-baseline gap-2">
            <span className="text-4xl font-bold text-primary-main">{profile.remainingClasses}</span>
