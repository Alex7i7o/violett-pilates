  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-primary-main">Disciplinas</h1>
      </div>

      <Card className="shadow-sm border-primary-light">
        ...
        {clases.length === 0 ? (
          ...
          <AnimatePresence mode="wait">
            {clases.map(clase => (
              ...
              >
                <Card className="hover:shadow-md transition-shadow border-primary-light/50">
                  <CardContent className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <h3 className="text-lg font-bold text-primary-main">{clase.nombre}</h3>
