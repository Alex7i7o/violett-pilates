            ...
            {data.mis_plantillas.map(p => (
              <Card key={p.id} className="relative overflow-hidden">
                <CardContent className="flex justify-between items-center p-4">
                  <div>
                    <Badge variant="secondary" className="mb-2 bg-primary-light text-primary-main">Horario Fijo</Badge>
                  ...
                  <div className="text-right">
                    <p className="text-primary-main font-medium">{p.clase_nombre}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
